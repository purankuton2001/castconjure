...
이미 오리지널 캐릭터를 가진 창작자(우선은 일본어로 작업하는 창작자)와, 영어·한국어·중국어로 해외에서 시청하는 팬을 위해 만들었습니다. 아이돌은 하나, 채팅은 전 세계, 사용 가능한 것은 나만의 오리지널 캐릭터뿐. 실사풍이든 애니풍이든 자유입니다. [Conjure Board](https://purankuton2001.github.io/conjure-board/)에서는 아이돌별로 창작자의 언어가 아닌 언어에서 온 반응의 비율을 볼 수 있습니다.
